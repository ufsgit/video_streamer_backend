...
SET @@GLOBAL.GTID_PURGED=/*!80000 '+'*/ '209751e0-37b8-11f1-bfed-40c2ba987f8c:1-47664,
...
CREATE TABLE `user_reminders` (
  `id` int NOT NULL AUTO_INCREMENT,
  `user_id` int NOT NULL,
  `reminder_time` time NOT NULL COMMENT 'Preferred notification time (HH:MM:SS, e.g., 20:00:00)',
  `is_enabled` tinyint(1) NOT NULL DEFAULT '0' COMMENT '1 = ON, 0 = OFF',
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
INSERT INTO `user_reminders` VALUES (1,40,'20:30:00',1,'2026-09-22 11:53:17','2026-09-22 11:59:24');
...
CREATE TABLE `user_video_progress` (
  ...
  `first_opened_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
INSERT INTO `user_video_progress` VALUES (5,37,1,6,213,0,'2026-09-22 10:09:54',NULL,'2026-09-22 10:09:48');
...
-- Dump completed on 2026-09-22 17:43:33
